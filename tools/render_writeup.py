...
Run:
    python3 tools/render_writeup.py                    # -> docs/main/architecture_report_main_full.html
    python3 tools/render_writeup.py --inline-mermaid -i docs/lightweight-portable/architecture_report_lightweight_full.md -o /tmp/print.html
...
def main() -> int:
    ...
    ap.add_argument("-i", "--input", default=os.path.join(
        ROOT, "docs", "main", "architecture_report_main_full.md"))
    ap.add_argument("-o", "--output", default=os.path.join(
        ROOT, "docs", "main", "architecture_report_main_full.html"))
